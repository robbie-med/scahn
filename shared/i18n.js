...
const STRINGS = Object.freeze({
  en: {
    ...
    'organ.Ovary': 'Ovary',
    'organ.Vagina': 'Vagina',
    'organ.Urethra': 'Urethra',
    'organ.Rectum': 'Rectum',
    'viewer.model.kvh-female-pelvis': 'Female pelvis',
    'organ.Ureter': 'Ureter',
    'organ.Artery': 'Artery',
    'organ.Vein': 'Vein',
    'organ.Bowel': 'Bowel',
    ...
    'phone.glideCam': 'Glide (camera)',
    'phone.flowHint': 'Hold, slide the phone across the body, release. The front camera watches the room — keep some of the room in view.',
    'phone.cameraUnavailable': 'Camera unavailable — use the drag pad or motion move.',
  ...
  ko: {
    ...
    'organ.Urethra': '요도',
    'organ.Rectum': '직장',
    'viewer.model.kvh-female-pelvis': '여성 골반',
    'organ.Ureter': '요관',
    'organ.Artery': '동맥',
    'organ.Vein': '정맥',
    'organ.Bowel': '장',
  ...
  fr: {
    ...
    'organ.Ovary': 'Ovaire',
    'organ.Vagina': 'Vagin',
    'organ.Urethra': 'Urètre',
    'organ.Rectum': 'Rectum',
    'viewer.model.kvh-female-pelvis': 'Bassin féminin',
    ...
    'phone.glideCam': 'Glisser (caméra)',
    'phone.flowHint': 'Maintenez, faites glisser le téléphone sur le corps, relâchez. La caméra frontale observe la pièce — gardez la pièce en vue.',
    'phone.cameraUnavailable': 'Caméra indisponible — utilisez le pavé tactile ou le mouvement.',
  ...
  zh: {
    ...
    'organ.Urethra': '尿道',
    'organ.Rectum': '直肠',
    'viewer.model.kvh-female-pelvis': '女性骨盆',
    'organ.Ureter': '输尿管',
    'organ.Artery': '动脉',
    'organ.Vein': '静脉',
    'organ.Bowel': '肠',
    ...
    'phone.glideCam': '滑动（摄像头）',
    'phone.flowHint': '按住，在身体上滑动手机，然后松开。前置摄像头观察房间——请保持房间在画面中。',
    'phone.cameraUnavailable': '摄像头不可用——请使用拖动板或运动移动。',
  ...
  ru: {
    ...
    'organ.Uterus': 'Матка',
    'organ.Ovary': 'Яичник',
    'organ.Vagina': 'Влагалище',
    'organ.Urethra': 'Уретра',
    'organ.Rectum': 'Прямая кишка',
    'viewer.model.kvh-female-pelvis': 'Женский таз',
    ...
    'phone.glideCam': 'Скольжение (камера)',
    'phone.flowHint': 'Удерживая, ведите телефон по телу, затем отпустите. Фронтальная камера следит за комнатой — держите комнату в кадре.',
    'phone.cameraUnavailable': 'Камера недоступна — используйте сенсорную область или движение.',
  ...
  ar: {
    ...
    'organ.Ovary': 'مبيض',
    'organ.Vagina': 'المهبل',
    'organ.Urethra': 'الإحليل',
    'organ.Rectum': 'المستقيم',
    'viewer.model.kvh-female-pelvis': 'الحوض الأنثوي',
    'organ.Ureter': 'حالب',
    'organ.Artery': 'شريان',
    'organ.Vein': 'وريد',
    'organ.Bowel': 'أمعاء',
    ...
    'phone.glideCam': 'انزلاق (كاميرا)',
    'phone.flowHint': 'اضغط مطولًا وحرّك الهاتف على الجسم ثم أفلِت. الكاميرا الأمامية تراقب الغرفة — أبقِ الغرفة في الإطار.',
    'phone.cameraUnavailable': 'الكاميرا غير متاحة — استخدم لوحة السحب أو الحركة.',
