...
const STRINGS = Object.freeze({
  en: {
    ...
    'viewer.roll': 'Roll to slide',
    'viewer.rollTitle': 'Rotate the phone about its long axis to slide the probe around the body',
  ...
  ko: {
    ...
    'viewer.muscles': '근육',
    'viewer.roll': '굴려서 이동',
    'viewer.rollTitle': '휴대폰을 긴 축으로 굴려 탐촉자를 몸 둘레로 이동합니다',
  ...
  fr: {
    ...
    'viewer.muscles': 'Muscles',
    'viewer.roll': 'Rouler pour glisser',
    'viewer.rollTitle': 'Faites pivoter le téléphone sur son grand axe pour faire glisser la sonde autour du corps',
  ...
  zh: {
    ...
    'viewer.muscles': '肌肉',
    'viewer.roll': '翻转滑动',
    'viewer.rollTitle': '绕手机长轴旋转，使探头沿身体周向滑动',
  ...
  ru: {
    ...
    'viewer.roll': 'Поворот для скольжения',
    'viewer.rollTitle': 'Поворачивайте телефон вокруг длинной оси, чтобы двигать датчик вокруг тела',
  ...
  ar: {
    ...
    'viewer.roll': 'التدوير للانزلاق',
    'viewer.rollTitle': 'أدر الهاتف حول محوره الطولي لتحريك المسبار حول الجسم',
